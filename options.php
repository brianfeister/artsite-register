...
function artsite_signup_options_setdefaults() {
	...
	if (!is_array($tmp)) {
		$arr = array( "namecheap_apiuser" => "", 'namecheap_apikey' => "", 'namecheap_clientip' => "", 'namecheap_sandbox' => 'yes', 'stripe_apikey' => '', 'stripe_apisecretkey' => '' );
...
<table id="artsite_options" class="form-table">
	<tr valign="top"><th scope="row">NameCheap API user</th><td><input maxlength="32" type="text" size="18" name="namecheap_apiuser" value="<?php if (!empty($options['namecheap_apiuser'])) echo htmlspecialchars($options['namecheap_apiuser']); ?>"/>
	</td></tr><tr valign="top"><th scope="row">NameCheap API key</th><td><input maxlength="32" type="text" size="18" name="namecheap_apikey" value="<?php if (!empty($options['namecheap_apikey'])) echo htmlspecialchars($options['namecheap_apikey']); ?>"/>
	</td></tr><tr valign="top"><th scope="row">NameCheap Client IP address</th><td><input maxlength="15" type="text" size="18" name="namecheap_clientip" value="<?php if (!empty($options['namecheap_clientip'])) echo htmlspecialchars($options['namecheap_clientip']); ?>"/>
...
<label for="namecheap_sandbox"> Yes, use sandbox</label></td></tr><tr valign="top"><th scope="row">Stripe API key (public)</th><td><input maxlength="32" type="text" size="18" name="stripe_apikey" value="<?php if (!empty($options['stripe_apikey'])) echo htmlspecialchars($options['stripe_apikey']); ?>"/>
	</td></tr><tr valign="top"><th scope="row">Stripe API key (secret)</th><td><input maxlength="32" type="text" size="18" name="stripe_apisecretkey" value="<?php if (!empty($options['stripe_apisecretkey'])) echo htmlspecialchars($options['stripe_apisecretkey']); ?>"/>
	</td></tr>
</table>
<?php
